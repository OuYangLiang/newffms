...
<html>
    ...
    <body>
        ...
        <div class="content-header ui-widget-header">
            收入<span style="font-size: 80%;"> - 新建</span>
        </div>
        ...
        <div class="contentWrapper">
            <div class="mainArea">
                ...
                <div class="newline-wrapper ui-widget-content">
                    ...
                    <div class="input">
                        <spring:input data-validation-engine="validate[required]" path="amount" class="inputbox" onBlur="javascript:checkAmount(this);" maxlength="11" />
                    </div>
                ...
                <div class="newline-wrapper ui-widget-content">
                    ...
                    <div class="input">
                        <input data-validation-engine="validate[required]" id="acntHumanDesc" value="<c:out value='${incomingForm.targetAccount.acntHumanDesc }' />" class="inputbox" readonly="true" onClick="javascript:selectAccount();" />
                        <input type="hidden" id="acntOid" name="targetAccount.acntOid" value="<c:out value='${incomingForm.targetAccount.acntOid }' />" />
                    </div>
